...
(function () {
    ...
    resultsViewModelDefinition.$inject = ["DataDelegate", "delegateFactory", "delegateUtils"];
    registerDelegate.$inject = ["resultsViewModelDefinition", "delegateFactory"];
    angular.module('ovpApp.dataDelegate').factory('resultsViewModelDefinition', resultsViewModelDefinition).run(registerDelegate);
        ...
        return new DataDelegate(angular.extend({}, delegateUtils.standardSearchParams, {
            ...
            clickRoute: cached(function (data) {
                ...
                if (['Person', 'Team', 'Sports'].includes(data.resultDisplay)) {
                    var toState = 'search.' + data.resultDisplay.toLowerCase();
                    var toParams = { query: data.searchStringMatch, uri: data.uri };
...
//# sourceMappingURL=../../maps-babel/ovpApp/data-delegates/results.js.map

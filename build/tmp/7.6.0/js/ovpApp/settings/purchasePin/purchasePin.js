...
(function () {
    'use strict';
    PurchasePinController.$inject = ["$scope", "$rootScope", "$controller", "$log", "purchasePinService", "messages", "$state", "purchaseSwitchFlag"];
    angular.module('ovpApp.settings.purchasePin', ['ovpApp.purchasePinDialog', 'ovpApp.components.ovp.ovpSwitch', 'ovpApp.services.purchasePinService', 'ovpApp.messages']).controller('PurchasePinController', PurchasePinController);

    /* @ngInject */
    function PurchasePinController($scope, $rootScope, $controller, $log, purchasePinService, messages, $state, purchaseSwitchFlag) {
...
//# sourceMappingURL=../../../maps-babel/ovpApp/settings/purchasePin/purchasePin.js.map

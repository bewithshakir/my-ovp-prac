...
(function () {
    ...
    var defaultConfig = {
        ...
        analytics: {
            ...
            blacklist: {
                urls: [
                    'https://v-collector.dp-bkp.prd-aws.charter.net/api/collector',
                    'https://splunk.ovp.timewarnercable.com/'
                ]
            },
        ...
        loginPath: '/',
        parentalControlsRootUrl: function () {
            return window.currentConfig.piHost;
        },
        parentalControls: {
            parentalControlsForUserUrl: function () {
                return window.currentConfig.parentalControlsRootUrl() + '/ipvs/api/smarttv/parentalcontrol/v1';
            },
            parentalControlsByRatingUrl: function () {
                return window.currentConfig.parentalControlsRootUrl() +
                    '/ipvs/api/smarttv/parentalcontrol/v1/ratings';
            },
            validatePINUrl: function () {
                return window.currentConfig.parentalControlsRootUrl() +
                    '/ipvs/api/smarttv/parentalcontrol/v1/pin/validate';
            },
            setPINUrl: function () {
                return window.currentConfig.parentalControlsRootUrl() + '/ipvs/api/smarttv/parentalcontrol/v1/pin';
            },
            parentalControlsByChannelUrl: function () {
                return window.currentConfig.parentalControlsRootUrl() +
                    '/ipvs/api/smarttv/parentalcontrol/v1/blockedchannels';
            },
            updateParentalControlsByChannelUrl: function () {
                return window.currentConfig.parentalControlsRootUrl() +
                    '/ipvs/api/smarttv/parentalcontrol/v1/blockedchannels';
            },
            validateAdminPasswordUrl: function () {
                return window.currentConfig.parentalControlsRootUrl() +
                    '/ipvs/api/smarttv/parentalcontrol/v1/admin/validate';
            }
        },
        purchasePinRootUrl: function () {
            return window.currentConfig.piHost;
        },
        purchasePin: {
            purchasePINUrl: function () {
                return window.currentConfig.purchasePinRootUrl() + '/ipvs/api/smarttv/tvod/v1/pin';
            },
            validatePurchasePINUrl: function () {
                return window.currentConfig.purchasePinRootUrl() + '/ipvs/api/smarttv/tvod/v1/pin/validate';
            }
        },
        customerInfoUrl : function () {
            return this.piHost +
                this.smartTvApi +
                this.smartTv.info;
        },
        ...
        featureTourSlides: [{
            ...
            description: 'Watch all of your favorite channels at home and many top-rated ' +
                ' networks from any WiFi connection.'
        },{
            index: 1,
            imageUrl: '/imageserver/supporting?image=ovp-6-0-channel-sort',
            headerText: '',
            subHeaderText: 'Channels A - Z or 1, 2, 3',
            description: 'Click anywhere on live video to sort the live TV guide by channel ' +
                'name or channel number. It\'s your choice!',
            ...
            description: 'Search by title, person or sports team to easily find live TV, On ' +
                'Demand and recorded DVR content.',
            ...
            description: 'Live TV, On Demand or on your DVR - it\'s all in one place. Spend ' +
            ...
            description : 'Browse by category or network, then add your favorites to Watch ' +
                'Later to keep them all in one place.',
            class: 'pull-image-right'
        },{
            index: 5,
            ...
            description: 'Find your in progress On Demand shows in the Watch Later menu. Tap the ' +
                'show, then Resume to continue watching.',
            class: 'pull-image-left'
        },{
            index: 6,
            ...
            description: 'To record a show, select the episode from the episode list, then choose' +
                ' Record. Select a series or single recording, choose your options and you\'re good to go!',
            class: 'pull-image-right'
        },{
            index: 7,
            ...
            description: 'Set a PIN and block by rating or channel. Blocks apply to all devices ' +
                'signed in with the same user name. To remove the block, just enter the PIN.',
            class: 'pull-image-left'
        }],

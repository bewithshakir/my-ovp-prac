...
(function () {
    ...
    podsWithAssetsDefinition.$inject = ["DataDelegate", "delegateFactory", "delegateUtils", "EntitlementsService"];
    registerDelegate.$inject = ["podsWithAssetsDefinition", "delegateFactory"];
    angular.module('ovpApp.dataDelegate').factory('podsWithAssetsDefinition', podsWithAssetsDefinition).run(registerDelegate);
...
//# sourceMappingURL=../../maps-babel/ovpApp/data-delegates/pods-with-assets.js.map

...
(function () {
    'use strict';
    OauthDataManager.$inject = ["StorageBuffer", "ovpStorage", "oAuthConfig", "deviceid", "$rootScope", "$timeout", "config"];
    angular.module('ovpApp.oauth').service('OauthDataManager', OauthDataManager).factory('StorageBuffer', StorageBufferFactory);
    /* @ngInject */
    function OauthDataManager(StorageBuffer, ovpStorage, oAuthConfig, deviceid, $rootScope, $timeout, config) {
        ...
        function initialize() {
            ...
            if (window.localStorage && window.localStorage.getItem) {
                Object.keys(migrationKeys).forEach(function (key) {
                    var legacyData = window.localStorage.getItem(key);
                    if (legacyData) {
    ...
    function StorageBufferFactory() {
        return {
            create: function create(storageObject) {
        ...
        function StorageBuffer(storageObject) {
            ...
            this.clearStaleBuffer = function () {
                var cleared = false;
                if (this.storage) {
                    var lastWriteTime = this.storage.getItem('_lastWriteTime');
...
//# sourceMappingURL=../../maps-babel/ovpApp/oauth/oauth-data-manager.js.map

...
(function () {
    ...
    loginService.$inject = ["config", "ovpStorage", "storageKeys", "$q", "OauthService", "locationService", "messages", "alert", "$rootScope", "errorCodesService"];
    angular.module('ovpApp.login.loginService', ['ovpApp.config', 'ovpApp.services.ovpStorage', 'ovpApp.oauth', 'ovpApp.messages', 'ovpApp.components.alert', 'ovpApp.services.errorCodes']).service('loginService', loginService);

    /* @ngInject */
    function loginService(config, ovpStorage, storageKeys, $q, OauthService, locationService, messages, alert, $rootScope, errorCodesService) {
        ...
        var service = {
            ...
            hasAcceptedParentalControlsWarning: hasAcceptedParentalControlsWarning,
            acceptParentalControlsWarning: acceptParentalControlsWarning,
            hasAcceptedSpecUTerms: hasAcceptedSpecUTerms,
            acceptSpecUTerms: acceptSpecUTerms,
        ...
        function authenticate(username, password, rememberMeCookie) {
            ...
            return OauthService.userLogin(username, password).then(function () {
                ...
                if (error.errorCode) {
                    ...
                    $rootScope.$emit('Session:loginActionComplete', { isSuccess: false, failureType: 'serviceError' });
                    serviceError({
        ...
        function hasAcceptedParentalControlsWarning() {
            var persistedControls = ovpStorage.getItem(storageKeys.parentalControlsAccepted);
...
//# sourceMappingURL=../../maps-babel/ovpApp/login/login-service.js.map

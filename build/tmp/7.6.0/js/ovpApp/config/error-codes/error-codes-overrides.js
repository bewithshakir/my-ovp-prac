...
(function () {
    ...
    angular.module('ovpApp.config.errorCodes.overrides', []).constant('ERROR_CODES_OVERRIDES', {
        'errorCodes': [{
            ...
            'full_customer_message': 'In most cases, Flash Player is pre-installed, so simply follow the prompts to allow or activate Flash. ' + 'If Flash Player isn\'t installed, you\'ll be prompted to install it, which should take only a moment.'
        }, {
...
/*eslint-enable */
//# sourceMappingURL=../../../maps-babel/ovpApp/config/error-codes/error-codes-overrides.js.map

...
(function () {
    ...
    productViewModelDefinition.$inject = ["DataDelegate", "delegateFactory", "delegateUtils", "productService", "$state", "BookmarkService"];
    registerDelegate.$inject = ["productViewModelDefinition", "delegateFactory"];
    angular.module('ovpApp.dataDelegate').factory('productViewModelDefinition', productViewModelDefinition).run(registerDelegate);
    ...
    /* @ngInject */
    function productViewModelDefinition(DataDelegate, delegateFactory, delegateUtils, productService, $state, BookmarkService /*, $rootScope*/) {
        ...
        return new DataDelegate(angular.extend({}, delegateUtils.standardSearchParams, {
            ...
            bookmark: function bookmark(data) {
                var bookmark = BookmarkService.getBookmarkByTmsProgramId(data.tmsProgramId);
                if (bookmark) {
...
//# sourceMappingURL=../../maps-babel/ovpApp/data-delegates/product.js.map

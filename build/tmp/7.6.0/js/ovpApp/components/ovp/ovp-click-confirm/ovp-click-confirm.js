...
(function () {
    ...
    OvpClickConfirmController.$inject = ["$scope"];
    clickOverride.$inject = ["$timeout", "$q", "$templateRequest", "popUpService", "$parse"];
    ovpClickConfirm.$inject = ["clickOverride"];
    angular.module('ovpApp.components.ovp.clickConfirm', ['ovpApp.components.popup']).controller('OvpClickConfirmController', OvpClickConfirmController).factory('clickOverride', clickOverride).directive('ovpClickConfirm', ovpClickConfirm);
    ...
    function clickOverride($timeout, $q, $templateRequest, popUpService, $parse) {
        return function (parentScope, $element, $attrs, $event) {
            ...
            var popupScope = parentScope.$new(false),
                ...
                templateDefer = $templateRequest('/js/ovpApp/components/ovp/ovp-click-confirm/ovp-click-confirm.html');
...
//# sourceMappingURL=../../../../maps-babel/ovpApp/components/ovp/ovp-click-confirm/ovp-click-confirm.js.map

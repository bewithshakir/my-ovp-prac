...
(function () {
    ...
    LegacyDateUtil.$inject = ["DATE_EXTENTION", "MONTH_NAMES", "DAY_NAMES"];
    angular.module('ovpApp.legacy.DateUtil', []).factory('dateUtil', LegacyDateUtil).constant('DATE_EXTENTION', ['st', 'nd', 'rd', 'th', 'th', 'th', 'th', 'th', 'th', 'th', 'th', 'th', 'th', 'th', 'th', 'th', 'th', 'th', 'th', 'th', 'st', 'nd', 'rd', 'th', 'th', 'th', 'th', 'th', 'th', 'th', 'st']).constant('DAY_NAMES', ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday']).constant('MONTH_NAMES', ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']);
    ...
    function LegacyDateUtil(DATE_EXTENTION, MONTH_NAMES, DAY_NAMES) {
        ...
        service.isToday = function (referenceDate, itemDate) {
            ...
            var timeDiff = eodToday.getTime() - itemDate.getTime();
        ...
        service.isTomorrow = function (referenceDate, itemDate) {
            ...
            var eodTomorrow = new Date(referenceDate.getTime());
            var msInDay = 24 * 60 * 60 * 1000;
            eodTomorrow.setTime(eodTomorrow.getTime() + msInDay);
            eodTomorrow.setHours(23, 59, 59, 999);

            return itemDate.getTime() > eodToday.getTime() && itemDate.getTime() <= eodTomorrow.getTime();
        };
        ...
        service.isYesterday = function (referenceDate, itemDate) {
            ...
            var bodYesterday = new Date(referenceDate.getTime());
            bodYesterday.setHours(0, 0, 0, 0);
            bodYesterday.setDate(bodYesterday.getDate() - 1);

            return itemDate.getTime() > bodYesterday.getTime() && itemDate.getTime() <= today;
        };
        ...
        service.getTimeFromGmt = function (gmTime, gmtOffset) {
            ...
            var serverOffsetSeconds = gmtOffset * 60 * 60;
            ...
            var offsetSeconds = serverOffsetSeconds + localOffsetSeconds;
...
//# sourceMappingURL=../../../maps-babel/ovpApp/components/util/DateUtil.js.map

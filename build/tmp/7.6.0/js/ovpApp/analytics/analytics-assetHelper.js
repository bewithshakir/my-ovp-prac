...
(function () {
    ...
    AnalyticsAssetHelper.$inject = ["$log"];
    angular.module('ovpApp.analytics.analyticsAssetHelper', []).factory('analyticsAssetHelper', AnalyticsAssetHelper);
    ...
    function AnalyticsAssetHelper($log) {
        ...
        function isTvodAsset(asset) {
            return asset && asset.isTvodEntitled && asset.tvodStream && asset.tvodStream.streamProperties && asset.tvodStream.streamProperties.tvodEntitlement;
        }
        ...
        function populateTvodData(target, asset) {
            ...
            var tvodStreamProperties = asset.tvodStream.streamProperties;

            // Collect rental expiration date in milliseconds.
            target.rentalExpirationDate = tvodStreamProperties.tvodEntitlement.rentalEndTimeUtcSeconds ? tvodStreamProperties.tvodEntitlement.rentalEndTimeUtcSeconds * 1000 : undefined;
        ...
        function isOnDemandContentClass(contentClass) {
            var result = contentClass && contentClass.endsWith('od') || false;
            return result;
        }
        ...
        function getTmsProgramId(assetOrStream) {
            ...
            if (assetOrStream.streamProperties && assetOrStream.streamProperties.tmsProviderProgramID) {
        ...
        * Find and return the assetProviderId in this asset, if defined.
        ...
        function isParentallyBlocked(asset) {
            ...
            if (asset && asset.defaultStream && asset.defaultStream.streamProperties) {
                ...
                isBlocked = asset.defaultStream.streamProperties.parentallyBlockedByChannel || asset.defaultStream.streamProperties.parentallyBlockedByRating || asset.isBlockedByParentalControls || false;
            } else if (asset) {
        ...
        function extractRecordingOptions(asset, cdvrSettings) {
            ...
            // Capture asset data.
            var defaultStream = asset.defaultStream || null;
            var defaultStreamProperties = defaultStream && defaultStream.streamProperties || null;
            ...
            var network = asset.network || null;
            ...
            for (var property in obj) {
                ...
                if (obj.hasOwnProperty(property) && typeof obj[property] !== 'object' && obj[property] !== null) {
                    ...
                    if (typeof value === 'string') {
                        ...
                        $log.warn('Analytics: Unexpected property type: ' + typeof value + ' for property ' + property, obj);
                    }
                }
            }
        ...
        function toLowerCamelCase(name) {
            ...
            var words = name.split(' ').map(function (s) {
        ...
        var service = {
            populateChannelData: populateChannelData,
            populateAssetData: populateAssetData,
            populateStreamData: populateStreamData,
            populateTvodData: populateTvodData,
            populateEventData: populateEventData,
            isTvodAsset: isTvodAsset,
            getTmsProgramId: getTmsProgramId,
            getTmsSeriesId: getTmsSeriesId,
            getTmsGuideId: getTmsGuideId,
            getAirtime: getAirtime,
            getEpisodeTitle: getEpisodeTitle,
            getProviderAssetId: getProviderAssetId,
            getContentClass: getContentClass,
            isParentallyBlocked: isParentallyBlocked,
            extractRecordingOptions: extractRecordingOptions,
            convertAllValuesToStrings: convertAllValuesToStrings,
            objToArray: objToArray,
            toLowerCamelCase: toLowerCamelCase,
            isOnDemandContentClass: isOnDemandContentClass,
            normalizeContentCategoryName: normalizeContentCategoryName,
            pruneUndefinedValues: pruneUndefinedValues
        };

        return service;
    }
})();
//# sourceMappingURL=../../maps-babel/ovpApp/analytics/analytics-assetHelper.js.map
